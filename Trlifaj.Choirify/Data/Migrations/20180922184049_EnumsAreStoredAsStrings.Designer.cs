...
namespace Trlifaj.Choirify.Data.Migrations
{
    ...
    [Migration("20180922184049_EnumsAreStoredAsStrings")]
    partial class EnumsAreStoredAsStrings
    {
            ...
            modelBuilder.Entity("Trlifaj.Choirify.Models.Song", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Author = "Green day", Current = true, Duration = new TimeSpan(0, 0, 0, 0, 0), IsDeleted = false, Name = "21 Guns", SheetType = "Unified", SheetsAvailable = 1 }
                    );
                });
